...
class TestPlatformSupport:
    ...
    def test_comment_platforms(self):
        ...
        expected = ["facebook", "instagram", "youtube", "linkedin", "reddit", "bluesky", "tiktok"]
...
class TestCommentsAPI:
    ...
    def test_list_posts_with_comments_params(self, client):
        ...
        client.list_posts_with_comments(
            platform="instagram", min_comments=5, limit=25, cursor="abc123"
        )
    ...
    def test_reply_to_comment(self, client):
        ...
        result = client.reply_to_comment(
            post_id="post_123", account_id="acc_123", message="Thank you!", comment_id="comment_123"
        )
    ...
    def test_reply_to_comment_reddit_subreddit(self, client):
        ...
        client.reply_to_comment(
            post_id="post_123", account_id="acc_123", message="Thanks!", subreddit="r/test"
        )
...
class TestMessagesAPI:
    ...
    def test_list_conversations_with_filters(self, client):
        ...
        client.list_conversations(platform="instagram", status="active", limit=25)
    ...
    def test_get_conversation(self, client):
        ...
        mock_response = Mock()
        mock_response.json.return_value = {"id": "conv_123", "participant": {"name": "John Doe"}}
        mock_response.raise_for_status = Mock()
        client._client.get.return_value = mock_response
    ...
    def test_send_message(self, client):
        ...
        result = client.send_message(
            conversation_id="conv_123", account_id="acc_123", message="Thanks for reaching out!"
        )
...
class TestWebhooksAPI:
    ...
    def test_list_webhooks(self, client):
        ...
        mock_response = Mock()
        mock_response.json.return_value = {"data": [{"id": "wh_1"}, {"id": "wh_2"}]}
        mock_response.raise_for_status = Mock()
        client._client.get.return_value = mock_response

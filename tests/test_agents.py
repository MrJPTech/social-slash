...
class TestBaseAgent:
    ...
    def test_initial_state_is_idle(self):
        ...
        class TestAgent(BaseAgent):
            ...
            async def process_item(self, item): return True
...
class TestCommentAgent:
    ...
    def test_get_pending_reviews(self, mock_late_client, mock_db):
        ...
        comment = mock_db.save_comment(post.id, 'late_comment_123', 'user1', 'uid1', 'Comment', 'instagram')
...
class TestDMAgent:
    ...
    def mock_late_client(self):
        ...
        client.get_messages.return_value = {
            'messages': [
                {'id': 'msg_1', 'message': 'Hello!', 'direction': 'incoming'}
            ]
        }

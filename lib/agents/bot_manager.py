...
class BotManager:
    ...
    def __init__(
        self,
        late_client: Optional[LateDistributionClient] = None,
    ...
    def get_bot(self, platform: str, prefer_primary: bool = True) -> Optional[BotAccount]:
        """
    ...
    def set_primary(self, late_account_id: str) -> bool:
        ...
        for other in bots:
            if other.platform == bot.platform and other.is_primary and other.late_account_id != late_account_id:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--action', choices=['list', 'available', 'register', 'deactivate',
                                            'activate', 'set-primary', 'stats'],
    ...
    parser.add_argument('--style', type=str, default='professional',
                       ...
                       help='Response style')
    parser.add_argument('--max-replies', type=int, default=60,
                       help='Max replies per hour')
    parser.add_argument('--cooldown', type=int, default=300,
                       help='Cooldown in seconds')
    ...
    if args.action == 'list':
        ...
        for bot in bots:
            ...
            print(f"    Rate limit: {bot.max_replies_per_hour}/hour, {bot.cooldown_seconds}s cooldown")

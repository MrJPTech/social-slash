    ...
    async def process_item(self, message_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if not self.check_rate_limit(
                ...
                self.stats['items_queued'] += 1
                self.format_console_output('queued', f"Rate limited - queued reply for {sender_name}")
                return True
    ...
    async def _get_conversation_history(
        ...
        try:
            ...
            for msg in reversed(messages):  # Oldest first
                history.append({
                    'is_me': msg.get('direction') == 'outgoing',
            ...
            if review:
                ...
                if dm_messages:
                    ...
                    if conversation:
                        ...
                        self.format_console_output('success', f"Approved reply sent to {conversation.participant_name}")
                        return True
...
if __name__ == "__main__":
    ...
    parser.add_argument('--platforms', type=str, default='instagram,telegram,reddit',
                       help='Comma-separated platforms')
    parser.add_argument('--auto-reply', action='store_true',
                       help='Auto-send replies')
    parser.add_argument('--poll-interval', type=int, default=30,
                       help='Poll interval in seconds')
    parser.add_argument('--response-delay', type=int, default=30,
                       help='Delay before sending reply')
